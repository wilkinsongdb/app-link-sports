...
@RestController
@RequestMapping("/api/aplicacao-link-sports-kafka")
public class AplicacaoLinkSportsKafkaResource {
    private final Logger log = LoggerFactory.getLogger(AplicacaoLinkSportsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public AplicacaoLinkSportsKafkaResource(KafkaProperties kafkaProperties) {
