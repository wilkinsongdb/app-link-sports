...
import com.linksports.app.config.KafkaProperties;
...
class AplicacaoLinkSportsKafkaResourceIT {
    ...
    void setup() {
        ...
        AplicacaoLinkSportsKafkaResource kafkaResource = new AplicacaoLinkSportsKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/aplicacao-link-sports-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/aplicacao-link-sports-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
